...
function testCase(options) {
  ...
  if (typeof options === 'object') {
    ...
    assertFunction = options['assertFunction'] || function () {
      return true;
    };
...
function runBaseTests() {
  px_layout_1 = document.getElementById('px_layout_1');

  suite('Base Automation Tests for px-responsive-layouts', function () {

    test('Polymer exists', function () {
      assert.isTrue(Polymer !== null);
    });
    test('px-responsive-layouts fixture is created', function () {
      assert.isTrue(document.getElementById('px_layout_1') !== null);
    });
